      ...
      function (nsPopover, $rootScope, $timeout, $templateCache, $q, $http, $compile, $document, $parse) {
          return {
              ...
              scope: {
                  ...
                  callBackEventsIndex: '=',
                  callBackEvents: '=',
                  nsPopoverCommonObject: '='
              },
              link: function (scope, elm, attrs) {
                  var defaults = nsPopover.getDefaults();
                  debugger
                  if (scope.callBackEventsIndex >= 0) {
                      scope.callBackEvents = scope.callBackEvents || [];
                      scope.callBackEvents[scope.callBackEventsIndex] = scope.callBackEvents[scope.callBackEventsIndex] || {};
                  }
                  else
                      scope.callbackObject = scope.callbackObject || {};
                  ...
                  } else if (attrs.hasOwnProperty("nsPopoverTriggerProgrammatically")) {
                      function openPopover(event) {
                          hider_.cancel();
                          displayer_.display(options.popupDelay, event);
                      }
					  if (scope.callBackEventsIndex >= 0) {
						scope.callBackEvents[scope.callBackEventsIndex].openPopover = openPopover;
					  }
					  else
						  scope.callBackEvents.openPopover = openPopover;
                  }
                  else {
